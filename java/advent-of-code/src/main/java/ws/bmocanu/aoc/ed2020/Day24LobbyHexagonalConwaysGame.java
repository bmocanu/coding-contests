...
public class Day24LobbyHexagonalConwaysGame extends SolutionBase {
    ...
    public static void main(String[] args) {
        ...
        floor = XMatrix.createIntMatrix2(floorSize, floorSize);
        ...
        Log.part1(XMatrix.iterateIntMatrix2ToSumOfValues(floor));

        for (int round = 0; round < 100; round++) {
            int[][] curMat = XMatrix.cloneIntMatrix2(floor);
        ...
        Log.part2(XMatrix.iterateIntMatrix2ToSumOfValues(floor));
